...
def update_profile(request,id):
    ...
    if request.method == 'POST':
        ...
        myprofile.save()
        #success(request, 'Profile ('+f_name+l_name+') has been updated successfully')
...
def update_niveau(request,id):
    ...
    if request.method == 'POST':
        ...
        myniveau.save()
        #success(request, 'Niveau ('+myniveau.name+') has been updated successfully')
